        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              color: Colors.white,
              child: Padding(
                padding: const EdgeInsets.fromLTRB(0, 0, 0, ConstraintStyleFeatures.spaceBetweenElements),
                child: Container(
                  ...
                  child: const Center(
                    child: Padding(
                      padding: EdgeInsets.symmetric(vertical: ConstraintStyleFeatures.spaceBetweenElements),
                      child: Text(
                        'بلا حدود',
            ...
            const SizedBox(height: ConstraintStyleFeatures.spaceBetweenElements),
            Padding(
              padding: const EdgeInsets.all(ConstraintStyleFeatures.spaceBetweenElements),
              child: Text(
                loggedInUser,
                style:TextStyleFeatures.sideBarTextStyle,
              ),
